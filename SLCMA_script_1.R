...
save.name = "/depot/socgen/data/solomon_beer/epigeneticDMEslcma/SLCMA_sexphy_out_1.rds"
...
selection.list = list(c(rep(TRUE, 200000), rep(FALSE, n.cpg-200000)), selections)
