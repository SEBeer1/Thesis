...
save.name = "/depot/socgen/data/solomon_beer/epigeneticDMEslcma/DME_SLCMA_sexphy_out_200001_400000.rds"
...
selection.list = list(c(rep(FALSE, 200000), rep(TRUE, 200000), rep(FALSE, n.cpg-400000)), selections)
