...
baseline_one_iteration = function(i, path.to.simFolder, path.to.outfolder, save.name = "BaselineIteration"){
...
pt.outFolder = "/depot/socgen/data/solomon_beer/uploadFolder/BaselineOut/"
sn = "BaselineIteration"

st = Sys.time()

for(i in (10*starting.i-9):(10*starting.i)){
  print(i)
  baseline_one_iteration(i, pt.simFolder, pt.outFolder, save.name = sn)
}
